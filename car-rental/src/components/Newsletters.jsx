...
export default function Newsletters() {
  return (
    <motion.div
      ...
      className="flex flex-col items-center justify-center text-center space-y-2 max-md:px-4 md:my-10 sm:my-3 mb-40 bg-[#F5F7FF] p-10 sm:mx-10 lg:mx-35 rounded-xl"
    >
      <motion.h1
